...
exports.analyzeMonthlySpending = void 0;
...
exports.analyzeMonthlySpending = (0, https_1.onCall)(async (request) => {
    // 1. Authenticate
    if (!request.auth) {
    ...
    if (!month) {
        throw new https_1.HttpsError("invalid-argument", "Month is required.");
    }
    ...
    try {
        ...
        const salary = (userData === null || userData === void 0 ? void 0 : userData.budget) || 2500;
        ...
        throw new https_1.HttpsError("internal", "Failed to analyze spending. Please try again later.");
    }
});
